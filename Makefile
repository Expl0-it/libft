...
#    Updated: 2024/02/19 13:13:45 by mamichal         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
# Paths and Files
VPATH = src:src/
SRC = ft_atoi.c ft_itoa.c ft_tolower.c ft_toupper.c \
		...
		#ft_lstlast.c ft_lstmap.c ft_lstnew.c ft_lstsize.c ft_write_fd.c 
